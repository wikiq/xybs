const config = {
  ...
  accounts: [
    {
      username: "18386361048", //用户名
      password: "hc18386361048", //密码
      openId: "ooru94n9YbbtizeXFfjC5RtUUsvU", //微信小程序抓包openid(可选)
      unionId: "oHY-uwcVrvMByxaF9hkL9e22bBwE", //微信小程序抓包unionId(可选)
      sign: true, //是否自动签到
      reSign: true, //是否重新签到
...
const reports = [
  [
    ...
    才来的那天最糗的事情就是去复印一点资料。平时在学校复印东西都是打印店的人复印的，从来没有自己亲手复印过。以为也没什么难的吧，谁知道我弄了半天都没复印出来，想想这么简单的事情又不好意思问同事，可急死我了。好在一个同事姐姐看见了，主动教我怎么��，还跟我说以后再有什么不懂的就问她，不用觉得不好意思。后来我就经常请教同事问题了，不会再觉得有什么好尴尬的了。
  ...
  [
    `在经历了一��的打杂工作，让我对公司的运作流程以及业务有了一个整体的了解，因此这一周我们的工作内容也有了一个小变化，除了进行简单的技术资料整理， 还有就是如何去做好这个产品方面的设计，我本来以为就���将具体的尺寸用工具测量出来，然后通过autocad画出来就可以了，但是结果并不是想象中那么简单。老板总是叫我一遍又一遍的检查画的图是否还有其他的错误，经过几天的检查，我开始感觉到一整天坐在电脑面前开始有些疲倦，整天面对着电脑，看着那枯燥无谓的图形，我有点开始厌倦了，但是我还是坚持着做着，细心的检查着。就这样我熬过了枯燥的一个星期。`,
  ],
  [
  ...
  [
    `经过一个多月的实习，虽然对公司不是那么的太了解，但是多少不等也有所了解。天天做着一样的事，感觉得无比的枯燥只有自己一个人坐在电脑面前一整天，只有电脑从早到晚的陪者我，觉得好孤独，没有了以前在学校的那种欢声笑语，没有在学校的那种轻松悠闲自在了，有的只是空虚和寂寞。有些时候闲下来就坐在电脑面前发呆，不知道做什么。 就这样一天一天的耗着，感觉除了工作以外，自己的生活中就没有其他的新鲜的事情，或者是��得人去回忆，留念的了，没有了色彩斑斓的生活，有的只是枯燥的工作有些时候都有点冲动想不干了，去换换别的工作，想给累积更多的社会知识和经验，但是想了想还没有那么的冲动，还是在原来的地方老实的呆着。`,
  ],
  [
  ...
  [
    `经过了一段时间的工作，又开始踏上了新的征程，进行新的锻炼。经过一段时间的匆匆忙碌后，终于有了可以闲下来的一点时间。可以稍微的偷懒一下，好好的享受一下工作之余的��乐。在这以后才上体验生活那种家庭生活的开始，开始我的新的工作：学习怎么做好日常生活中的细事，比如说说是挖排水沟，看似一件简单事，但是实际哂纳感做起来就显得的非常的棘手，对于我们刚步入社会的新大学生来说无疑是一个重大的考验，虽然我并不知道怎么去弄，更不知道如何弄好，但是我还是在其中努力的学习，领悟其中的心得。这些活原来在家里并要自己去做，但我在这里能够亲身的体验到家人的辛苦与劳累。只有自己亲身经历，才能深刻体会。`,
  ],
  [
    `上一周的劳累与辛苦使我牢记心理，不过这一周又学到新的东西，虽然简单但是也很容易出错，我和我一个师傅去浇水泥板，在浇焊一块铁架子，放在里面来增加的它的强度，以防被什么大型__从上面走的时候压坏了，我看着师傅做，便好奇的问你为什么不做成和扳子一样大的架子呢?师傅起初并没有告诉我为什么这样做，我一直带着这样的疑问。后来和他一起浇的时候才发现，如果和它弄成一样大的话结果就放不进去，或者说以后弄出来，边上就会不平齐，不仅外观上面不怎么好看，而且有些时候不注意的话，他人从它旁边经过的会弄伤其他人。这个���然简单，也许在书上的时候大家都会说，但你一旦在真正实践的时候就会想不到，只有实践了，才能更深的体会。`,
  ],
  [
    `本周是我在公司C的第三周实习，我在这一周中积极参与工作，并不断学习和成长。在本周的实习中，我继续参与了公司的日常工作，并且承担了一些更具挑战性的任务。通过这些工作，我进一步提高了自己的专业知识和技能，并学会了更加高效地处理工作。与此同时，我也注意到了团队合作的重要性。在与同事的合作中，我学到了如何更好地沟通和协调，以实现共同的目标。大家相互支持和理解，共同努力，使我们能够充分发挥个人的优势，以最佳的方式完成工作。在这一周的实习中，我还有幸参与了一次行业内的研讨会。在研讨会中，专家们分享了他们的经验和见解，让我对行业的未来发展有了更清晰的认识。我也有机会与其他实习生和专业人士进行交流和讨论，拓宽了我的视野。尽管在实习过程中遇到了一些困难和挑战，但我通过积极的态度和不断努力克服了它们。我相信，挑战是成长的机遇，只有在面对困难时，我们才能够发挥出自己的潜力。总的来说，这一周的实习经历让我受益匪浅。我��仅学到了专业知识和技能，还提高了自己的团队合作能力和解决问题的能力。我期待在接下来的实习中，继续努力学习和成长，为公司做出更大的贡献。`,
  ],
  [
  ...
  [
    `这周星期一是我实习单位，_周年庆祝活动，同事们就提议说晚上搞个聚会，没有结婚的人都可以参加，结了婚的也可以参加，正式员工可以参���，实习员工也可以参加。虽然我来的时间不长，但是同事们说我必须参加，不许找借口不去。我想这是个很好的机会让我更加了解这些对我这么好，这么照顾我的同事们。我对他们说过，这里的工作氛围让人感觉好轻松，每个人都好亲切。他们告诉我，除了主任是本地人，其他的工作人员都是来自五湖四海，本来就是背井离乡，所以大家在一起就难免变得互相理解，互相帮助，人在外，谁没有个难处呢。是啊，人在外，谁没个难处呢。多么朴实却温暖的一句话。
  ...
  [
    `周一开始我跟其他几位同事去分部工作，所以最近上班���场所一直都是在单位分部，每
    ...
    这一周，我总结了工作过程中的关于挫折的感悟。在工作过程经过遇到一些挫折。关于挫折，早有职场高手总结出至理名言：“人在职场飘，哪能不挨刀?”这是一种对工作洒脱的态度。对待工作的挫折，就稍微转换一下努力的��向。说不定更好。另外一点也很重要，困境中请你自己鼓励自己，不到万不得已，请不要把自己的底牌亮给别人。要知道，困难时要求得到的帮助，价码总是会更贵一些的。`,
  ],
  [
    ...
    本周我总结出：在职场上取胜的黄金定律之一便是要有责任心，凡事尽力而为，并且要任劳任怨。在工作上，永远不要试图去敷衍自己的老板。有人曾经访问过许多在事业上功成名就的人，��们一个共同的特点便是，在工作上投入的时间及精力，远远要比工作本身所要求的多。我相信我能做的更好。`,
  ],
  [
    ...
    工作过程我得出了一些体会：我工作过程要相信自己，如果做不到这一点，你就无法成为一个好的职员或者好的领导。一个相信自己的人，才会在走路时神采飞扬，让老板看上去你有无穷的精力;一个相信自己的人，才会在待人接物时落落大方，这一切能帮助老板培养对你的信心，必要时才会委你以重任。你怎么对待别人，别人就会怎么对待你。在工作中，要待人如待己。在你困难的时候，你的善行会衍生出另一个善行。在别人���到困境时，热情地伸出援手。在职场上，尽可能地做一个与人为善的好人，这样，当你在工作上不小心出现纰漏，或当你面临加薪或升职的关键时刻，可尽可能减少别人放冷箭的危险。`,
  ],
  [
  ...
  [
    `这周，我感受到自己遇到的客户真的特别的难缠，而且也是目标的增加，让我感觉到了压力，最终这周的业绩目标还是差一些，没有完成，我也是特别的懊恼，周五下班之后，部长也是找我谈话，对��我没有完成业绩，他也是没有说太多，也是鼓励了我，说虽然目标是没完成，但是和之前相比，其实也是一直都在进步的，而且工作之中，怎么可能不会遇到挫折。
  ...
  [
    ...
    况且我还是个实习的，我想等我经历得更多，对于客户更加的熟悉，有了更多的经验，那么我的业绩也是会���列前茅的，特别是我也是感受到看到我的成绩，其他和我一起来到公司实习的同事，也是更加的努力了，的确别人可以，那么我为什么就不行，其实也是努力，去执行，去多反思把方法用对，业绩的目标是完全可以达成的。`,
  ],
];
